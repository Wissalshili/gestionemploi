...
function Registre() {
  ...
  async function save(event) {
    ...
    try {
      ...
      await axios.post("http://localhost:8080/user/RegisterS", requestData);
      navigate('/login');
    } catch (err) {
      setSignupError(true);
    }
      ...
      <div className="form-container-wrapper">
        <div className="form2-container">
          <h2>
            ...
            &nbsp;&nbsp;&nbsp;
            <Link to="/registerS" className="log">
            Registration
            </Link>
          </h2>
          ...
          <div className="logo-text-container">
            <div className="form-text">
              <h2 style={{ fontSize: "30px" }}>
                ...
                Complete the form below to register and access your Student account.
                </span>
              </h2>
            </div>
          </div>
