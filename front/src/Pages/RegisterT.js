...
function Registre() {
  ...
  async function save(event) {
    ...
    if (!firstname || !lastname || !phone || !department || !email || !password) {
      setSignupError(true);
      return;
    }
    ...
    try {
      ...
      await axios.post("http://localhost:8080/user/RegisterT", requestData);
      navigate('/login');
    } catch (err) {
      setSignupError(true);
    }
      ...
      <div className="form-container-wrapper">
        <div className="form2-container">
          <h2>
            ...
            &nbsp;&nbsp;&nbsp;
            <Link to="/registerT" className="log">
            Registration
            </Link>
          </h2>
          ...
          <div className="logo-text-container">
            <div className="form-text">
              <h2 style={{ fontSize: "30px" }}>
                ...
                Complete the form below to register and access your Teacher account.
                </span>
              </h2>
            </div>
          </div>
